...
To import show information, jump into script/console and run the following:

<pre><code>Importers::ComedyFestival.import_2010</code></pre>

Once you've done that, you'll probably want to load at least some tweets for shows:
